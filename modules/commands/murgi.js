...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("SH4WON BOSS কাকে চুদা লাগবে @ম্যানশন🙈", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a(" ๛➣𓆩𝐒𝐇𝐀𝐖𝐎𝐍--𝑺᭄𓆪‣𒁍 এর চুদা লো");
...
setTimeout(() => {a({body: "আমি তোর বাপ ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵 ---𝑺᭄𓆪‣𒁍 যেইখানে দেখবি সেইখানে দিবি সালাম🫡👹 🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵 ----𝑺᭄𓆪‣𒁍 তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি  ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵 ---𝑺᭄𓆪‣𒁍 এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a("~  ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵 ----𝑺᭄𓆪‣𒁍 এর জারজ সন্তান🤖")} , 93000);
...
setTimeout(() => {a({body: "Hi  ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵----𝑩᭄𓆪‣𒁍 এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি  ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵----𝑩᭄𓆪𒁍 এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
...
setTimeout(() => {a("~๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵----𝑩᭄𓆪𒁍 এর জারজ শন্তান জা ভাগ🤖")} , 171000);
...
setTimeout(() => {a({body: "Hi ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵----𝑩᭄𓆪‣𒁍 এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~  ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵----𝑩᭄𓆪𒁍 এর ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ ๛➣𓆩𝑺𝑯𝑨𝑾𝑶𝑵----𝑩᭄𓆪‣𒁍 তোর বাপ লাগে পুত। জা ভাগ🤖")} , 39000);
